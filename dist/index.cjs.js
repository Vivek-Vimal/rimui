...
var getBackgroundColor = function (_a) {
    ...
    return theme.colors[variant === variants.SUBTLE ? "tertiary" : "tertiary"];
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React__default['default'].createElement("image", { width: "26", height: "26", href: isDark ? '/images/logoTextDark.png' : '/images/logoTextLight.png' })));
};
        ...
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(Flex, null,
                ...
                React__default['default'].createElement(UpdatedFlex, { alignItems: "center" },
                    ...
                    React__default['default'].createElement(Link, { href: "/farms" },
                        React__default['default'].createElement(T, null, "Farms")),
                    React__default['default'].createElement(Link, { href: "/pools" },
                        React__default['default'].createElement(T, null, "Pools")),
                    React__default['default'].createElement(Link, { href: "/nft" },
                        React__default['default'].createElement(T, null, "NFT")),
                    React__default['default'].createElement(Link, { href: "/ifo" },
                        React__default['default'].createElement(T, null, "IFO")))),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { backgroundImg: '', title: "#000000", navBar: "linear-gradient(to right, #000000, #434343)", sideBar: "linear-gradient(to right, #000000, #434343)", heading: "#7f00ff", background: " #434343", backgroundDisabled: "#000", minibg: "/images/darkbg.png", lotterybg: "/images/whitelottery.png", contrast: "#191326", invertedContrast: "#FFFFFF", input: "linear-gradient(to left, #000000, #434343)", tertiary: "#EFF4F5", text: "#E5E5E5", textDisabled: "#BDC2C4", textSubtle: "#000", borderColor: "#E9EAEB", card: "linear-gradient(to right, #000000, #434343)", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { backgroundImg: '/bg1.gif', title: "#FFFFFF", navBar: "#27262c", sideBar: "#27262c", secondary: "#DC143C", background: "#000000", minibg: "/images/whitebg.png", lotterybg: "/images/blacklottery.png", heading: "linear-gradient(to right, #7f00ff, #e100ff)", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
